...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public MyScreenRecorder(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat,
			Format mouseFormat, Format audioFormat, File movieFolder, String string) throws IOException, AWTException {
...
//		Taking Evidence Path to store video
		File file = new File(BaseClassImplement.getEvidencePath());
